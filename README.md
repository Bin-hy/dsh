...
| 状态 | 计划 |
|---|---|
| ✅ 已发布 | 01~08（核心循环 → 持久化与工程化） |
| 🔬 研究中 | 09 会话持久化内核 · 10 进程外子代理与 ACP · 11 作用域与事件内核 · 12 终端与 PTY |
| ⬜ 排队中 | 13 技能深入 · 14 前端渲染内核 · 15 调度/命令/会话引用 · 16 重试/凭据 · 17 编排补遗 · 18 启动/组合/沙箱补遗 · 19 测试体系/Typert · 20 compaction/计量补遗 |
