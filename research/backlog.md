...
## A16 · 重试、凭据与 LLM 补遗 ✅（已消化 → deep-dive/llm-supplement；研究笔记 research/14-retry-credentials.md 在工作区）
...
- ✅ A13-5 已归档（→ 考古⑨）（18 个注册文件）跨 bundle 顺序未逐一枚举
- ✅ A13-6 已归档（→ 考古⑨） 与工作区折叠的最终顺序是推理，未跑组合测试
- ✅ A13-7 已修正（→ 考古⑨）与"模型可见 ⟺ 已记录"的张力仅在注释层面解释
- ✅ A13-8 已归档（→ 考古⑩）节点的组合未单独测试
...
- ✅ A15-10 证伪（→ 考古⑪）（schedule/change vs goal/change vs command/run）
